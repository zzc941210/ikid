...
class FirstViewController: UIViewController {
    ...
    fileprivate var secondViewController : FirstViewController!
    ...
    fileprivate func firstBuilder() {
        if firstViewController == nil {
            firstViewController =
                storyboard?.instantiateViewController(withIdentifier: "firstJoke") as! FirstViewController
        }
    }
    ...
    fileprivate func secondBuilder() {
        if secondViewController == nil {
            secondViewController =
                storyboard?.instantiateViewController(withIdentifier: "firstPunchline") as! FirstViewController!
        }
    }
